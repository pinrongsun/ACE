...
Partial Class Program
    ...
    Private Function getProgram(confDay As String, Optional confTime As String = "", Optional stream As String = "", Optional search As String = "") As DataTable
        Dim selectedField As String = "a.TitleOfPresentation, a.FocusArea1, d.RoomNumber,s.isVisible, s.SessionID, s.SessionTime, d.SessionID, d.PresentationID, a.Combine_Speakers, isnull(a.IsCancel,0) as IsCancel"
    ...
    Private Function getProgramHTML(confDay As String, confDayNo As Integer, lstBookmark As List(Of Integer), lstFeatured As List(Of Integer), Optional showOnlyBookmark As Boolean = False, Optional confTime As String = "", Optional stream As String = "", Optional search As String = "") As String
        ...
        Dim programTime As String = "", programTimeBoxNo As Integer = -1, bookmarkCSS As String = "", cancellCSS = "checked-program", checkedTimeCSS = "unchecked-time"
        ...
        If showOnlyBookmark Then
            ...
            For Each drProgram As DataRow In dtProgram.Rows
                If lstBookmark.Contains(drProgram("PresentationID").ToString) Then
                    hasBookmark = True
                    If drProgram("isVisible").ToString = "True" Then
                        checkedTimeCSS = "unchecked-time checked-time"
                    Else
                        checkedTimeCSS = "unchecked-time"
                    End If
                    ...
                    If programTime <> drProgram("SessionTime").ToString Then
                        ...
                        programHTML &= "<div class='programTimeBox' data-no='" & programTimeBoxNo & "'><p class='programTime'><span class='timeIcon'></span><span class='timeValue'>" & programTime & "</span><span class='" & checkedTimeCSS & "' data-id='" & drProgram("SessionID").ToString & "' onclick='checkedTime(this,event);'></span>" & featuredText & "</p><div class='programBoxLink'>"
                    End If
                    If lstBookmark.Contains(drProgram("PresentationID").ToString) Then
                    ...
                    If drProgram("IsCancel").ToString = "True" Then
                        cancellCSS = "checked-program cancelled-program"
                    Else
                        cancellCSS = "checked-program"
                    End If
                    ...
                    If Not String.IsNullOrEmpty(drProgram("Combine_Speakers").ToString) Then
                        programHTML &= "<p class='programSpeaker'>Speaker(s): " & drProgram("Combine_Speakers").ToString & "<span class='" & cancellCSS & "' onclick='cancelProgram(this,event);'></span><p/>"
                    End If
                    programHTML &= "</div>"
                End If
            Next
                ...
                For Each drPoster As DataRow In dtPoster.Rows
                    If lstBookmark.Contains(drPoster("PresentationID").ToString) Then
                        ...
                        If Not String.IsNullOrEmpty(drPoster("Combine_Speakers").ToString) Then
                            programHTML &= "<p class='programSpeaker'>Speaker(s): " & drPoster("Combine_Speakers").ToString & "<span class='" & cancellCSS & "' onclick='cancelProgram(this,event);'></span><p/>"
                        End If
                        programHTML &= "</div>"
                    End If
                Next
