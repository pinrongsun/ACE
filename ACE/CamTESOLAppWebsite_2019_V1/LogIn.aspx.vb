    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            If Request.Url.ToString.Contains("deviceid=") Then
                ...
                If Request.Url.ToString.Contains("PlayerID=") Then
                    PlayerID = Request.QueryString("PlayerID")
                End If

                Response.Redirect("https://camtesol.org/LogIn?AppView=&deviceid=" & Request.QueryString("deviceid") & "&PlayerID=" & PlayerID)
