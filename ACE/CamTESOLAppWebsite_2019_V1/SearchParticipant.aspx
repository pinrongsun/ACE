<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SearchParticipant.aspx.vb" Inherits="Default2" %>
                ...
                <div style="padding:5px">
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="dplSearchFeild" runat="server" CssClass="dropdown" Width="100%">
                                        <asp:ListItem>GivenName</asp:ListItem>
                            ...
                            <tr>
                                <td>Keyword:</td>
                                <td>
                                    <asp:TextBox ID="txtkeyword" runat="server" placeholder="Enter your keyword" Width="100%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <asp:Button ID="btnSearch" runat="server" CssClass="button" Text="Search" Width="90px" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="gdSearch" runat="server" CssClass="grdSchedulestyle" GridLines="None" HeaderStyle-Font-Bold="true" RowStyle-Height="30px" RowStyle-HorizontalAlign="Center" RowStyle-VerticalAlign="Middle" Width="100%">
                                        <AlternatingRowStyle BackColor="#f2f2f2" />
                                        <EmptyDataTemplate>
                                            No data found!
                                        </EmptyDataTemplate>
                                        <HeaderStyle BackColor="#AD2244" Font-Size="14px" ForeColor="white" height="30px" HorizontalAlign="Center" VerticalAlign="Middle" />
                                        <RowStyle Font-Size="13px" Height="50px" HorizontalAlign="left" VerticalAlign="Middle" />
