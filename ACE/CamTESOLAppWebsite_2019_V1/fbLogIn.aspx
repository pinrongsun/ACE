<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fbLogIn.aspx.vb" Inherits="Default2" %>
...
<div class="login-page">
 <div style="width: 100%">
            <asp:Image ID="Image1" runat="server" ImageUrl="~/Upload_s/app_banner.jpg" 
                Width="100%" />
        </div>
  ...
  <div class="form">
    ...
    <asp:Button ID="btnLogin" runat="server" Text="login" CssClass="button" />
      ...
      <div onclick="getRedirectURI()" id="fbLoginLink"><img id="Img1" alt="facebook" runat="server" src="~/img/Menu/fb.png" style="width: 40px; height: 40px; vertical-align: middle;" /><a>Log In</a></div>
      ...
      <div id="status"></div>
            ...
            <asp:TextBox ID="txtpassword_create" runat="server" placeholder="password" 
