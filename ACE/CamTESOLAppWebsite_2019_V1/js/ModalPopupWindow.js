...
function ModalPopupWindow() {
   // var strOverLayHTML = '<div id="bailwal_div_overlay" onmousemove="bailwal_modalPopupWindow.DoDragging(event)" onmouseup="bailwal_modalPopupWindow.StopDragging()" style="position:absolute;z-index:10; background-color:WHITE; filter: alpha(opacity = 70);opacity:0.7;"></div><div id="bailwal_div_frame_parent" style="position:absolute;z-index:12; display:none;background-color:white;border:1px solid;-moz-box-shadow: 0 0 10px 10px #BBB;-webkit-box-shadow: 0 0 10px 10px #BBB;box-shadow: 0 0 10px 10px #BBB;"><table width="100%" border="0" cellpadding="0" cellspacing="0" onmouseup="bailwal_modalPopupWindow.StopDragging()"><tr style="background-color:Gray;" id="bailwal_tr_title" onmousedown="bailwal_modalPopupWindow.StartDragging(event,this)" onmousemove="bailwal_modalPopupWindow.DoDragging(event)" onmouseup="bailwal_modalPopupWindow.StopDragging()"><td align="left"><span id="bailwal_span_title" style="color:White;font-size:9pt;padding-left:2px"></span></td><td  align="right" style="height:25px;"><span id="bailwal_span_overlay_window_max" style="display:none" onclick="Maximisze();" style="cursor:pointer">max</span><span onclick="bailwal_modalPopupWindow.HideModalPopUp();" style="cursor:pointer"> <img id="bailwal_img_overlay_close"  src="" alt="X" /> </span></td></tr><tr ><td colspan="2" align="center" width="100%" id="bailwal_td_overlay"><div id="bailwal_div_message" style="margin-top:20px;display:none;"   ><span id="bailwal_span_message" style="padding-left:40px;padding-top:10px;padding-bottom:10px; font-size:9pt;"  ></span></div><span id="bailwal_span_loading"><img id="bailwal_img_overlay_loading" src="" alt="Loading..." /></span><iframe onload="bailwal_modalPopupWindow.OnUrlLoaded()" name="bailwal_overlay_frame" id="bailwal_overlay_frame" src="/Blank.htm" frameborder="0" scrolling="auto" ></iframe> </td></tr><tr id="bailwal_tr_overlay_btn" ><td colspan="2" align="center" style="padding-top:20px;padding-bottom:10px;"><input type="button" id="baiwlal_btn_overlay_1" onclick="bailwal_modalPopupWindow.HideModalPopUp()" value="Ok" style="padding:3px; border:1 solid #dcdcdc;BACKGROUND-COLOR: #f5f5f5;"   /><input type="button" id="bailwal_btn_overlay_2" onclick="bailwal_modalPopupWindow.HideModalPopUp()" value="Cancel" style="padding:3px;margin-left:20px;border:1 solid #dcdcdc;BACKGROUND-COLOR: #f5f5f5;"   /> </td></tr></table></div>';
    var strOverLayHTML = '<div id="bailwal_div_frame_parent" style="position:absolute;display:none;z-index:12;background-color:white;border:1px solid;'
                    + '-moz-box-shadow: 0 0 10px 10px #BBB;-webkit-box-shadow: 0 0 10px 10px #BBB;box-shadow: 0 0 10px 10px #BBB;">' 
                    + '<table width="100%" border="0" cellpadding="0" cellspacing="0" onmouseup="bailwal_modalPopupWindow.StopDragging()">'
                    + '<tr style="background-color:Gray;" id="bailwal_tr_title" onmousedown="bailwal_modalPopupWindow.StartDragging(event,this)"'
                    + 'onmousemove="bailwal_modalPopupWindow.DoDragging(event)" onmouseup="bailwal_modalPopupWindow.StopDragging()">'
                    + '<td align="left"><span id="bailwal_span_title" style="color:White;font-size:9pt;padding-left:2px"></span></td>'
                    + '<td  align="right" style="height:25px; text-align: right; padding-right: 10px;"><span id="bailwal_span_overlay_window_max" style="display:none" onclick="Maximisze();"' 
                    + 'style="cursor:pointer">max</span><span onclick="bailwal_modalPopupWindow.HideModalPopUp();" style="cursor:pointer"> '
                    + '<img id="bailwal_img_overlay_close"  src="" alt="X" /> </span></td></tr><tr >'
                    + '<td colspan="2" align="center" width="100%" id="bailwal_td_overlay">'
                    + '<div id="bailwal_div_message" style="margin-top:20px;display:none;" >'
                    + '<span id="bailwal_span_message" style="padding-left:40px;padding-top:10px;padding-bottom:10px; font-size:9pt;"  >hello world</span></div>'
                    + '<span id="bailwal_span_loading"><img id="bailwal_img_overlay_loading" src="" alt="Loading..." /></span>'
                    + '<iframe onload="bailwal_modalPopupWindow.OnUrlLoaded()" name="bailwal_overlay_frame" id="bailwal_overlay_frame" src="/Blank.htm" frameborder="0" scrolling="auto" ></iframe>'
                    + '</td></tr><tr id="bailwal_tr_overlay_btn" >'
                    + '<td colspan="2" align="center" style="padding-top:20px;padding-bottom:10px; text-align: center;"><input type="button" id="baiwlal_btn_overlay_1" onclick="bailwal_modalPopupWindow.HideModalPopUp()" value="Ok" style="padding:3px; border:1 solid #dcdcdc;BACKGROUND-COLOR: #f5f5f5; margin-left: 20px;"   />'
                    + '<input type="button" id="bailwal_btn_overlay_2" onclick="bailwal_modalPopupWindow.HideModalPopUp()" value="Cancel" style="padding:3px;margin-left:20px;border:1 solid #dcdcdc;BACKGROUND-COLOR: #f5f5f5;" />';
                    + '</td></tr></table></div>'
    var orginalHeight;
    var orginalWidth;
    var btnStyle="";
    ...
    function __InitModalPopUp(height, width, title) {
        ...
        //************************
        //var imagewidth = 0;
        //imagewidth = document.getElementById("ImageButton1").offsetWidth;
//        alert(x);
        //***************
        var left = (window.screen.availWidth - width) / 2;
        var top = (window.screen.availHeight - height) / 3;
        var xy = GetScroll();
        left += xy[0];
        top += xy[1];
