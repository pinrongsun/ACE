...
Public Class DalGlobalEDB_app
    Private Shared GlobalInstance As DalGlobalEDB_app


    Public Shared ReadOnly Property Instance As DalGlobalEDB_app
        Get
            If GlobalInstance Is Nothing Then
                GlobalInstance = New DalGlobalEDB_app
            End If
...
#Region "Get DateTime from sql server"
    ...
    Public Shared Function GetCurrentDate(ByVal sqlTran As SqlTransaction) As DateTime
        ...
        Try
            ...
            sqlConn.ConnectionString = DalConnection_app.EDBConnectionString
